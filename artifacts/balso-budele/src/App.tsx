...
function InterestForm({
  ...
  return (
    <form
      action="https://formspree.io/f/mbgjyjnr"
      method="POST"
  ...
  return (
    <>
      ...
      <main className="min-h-[100dvh] overflow-hidden bg-[#F8F3EA] text-[#2B2620]">
        <section
          id="pradzia"
          className="hero-shell relative isolate flex min-h-[100svh] flex-col overflow-hidden"
        ...
        >
          ...
          />
          <header
            className="flex w-full items-center justify-between px-6 py-7 sm:px-10 sm:py-9 lg:px-16"
          ...
          >
            ...
            <span
              className="h-px w-16 bg-[#B08D57] sm:w-24"
              aria-hidden="true"
            />
          </header>
          ...
          <div className="absolute inset-0 z-10 flex w-full items-center px-6 sm:px-10 lg:px-16">
            <div className="hero-copy pointer-events-auto max-w-[36rem]">
              <h1
                id="hero-headline"
                className="page-reveal max-w-[12ch] font-serif text-[clamp(3.25rem,9vw,7.4rem)] leading-[0.96] tracking-[-0.055em] text-[#F8F3EA] lg:max-w-[13ch] lg:text-[clamp(4.5rem,6vw,6.4rem)]"
              >
              ...
              <p className="page-reveal page-reveal-delay-1 mt-7 max-w-2xl text-lg leading-[1.5] text-[#F8F3EA]/85 sm:text-xl">
                Nauja koncepcija vestuvėms – elegantiška telefono būdelė,
                kurioje svečiai palieka balso žinutę jaunavedžiams.
              </p>
        ...
        <div className="mx-auto w-full max-w-5xl px-6 sm:px-10 lg:px-16">
          <section
            id="kas-tai"
            className="page-reveal pb-24 pt-20 sm:pb-32 sm:pt-28"
            aria-labelledby="concept-title"
            data-testid="section-concept"
          >
            <div className="border-b border-[#D8CDBE] pb-16 sm:pb-20">
              <div
                className="mb-9 flex items-center gap-2 text-[#B08D57]"
                aria-hidden="true"
              >
              ...
              <h2
                id="concept-title"
                className="mb-9 font-serif text-3xl tracking-[-0.03em] sm:text-4xl"
              >
                Kas tai?
              </h2>
              <div className="max-w-2xl divide-y divide-[#D8CDBE] text-lg leading-[1.55] text-[#6B6357]">
                <p
                  ...
                  data-testid="text-concept-line-1"
                >
                  Pilno dydžio, elegantiška telefono būdelė, pritaikyta vestuvių
                  estetikai.
                </p>
                <p className="py-5" data-testid="text-concept-line-2">
                  Izoliuota nuo aplinkos triukšmo – balsas skamba aiškiai ir
                  švariai.
                </p>
                <p className="py-5 last:pb-0" data-testid="text-concept-line-3">
                  Veikia ir kaip išskirtinis dekoro elementas pačioje šventėje.
                </p>
              </div>
            </div>
          </section>
          ...
          >
            <div>
              <h2
                id="signup-title"
                className="mb-9 max-w-2xl font-serif text-3xl tracking-[-0.03em] sm:text-4xl"
              >
                Norite sužinoti pirmieji?
              </h2>
              <p
                className="mb-9 max-w-xl text-lg leading-[1.55] text-[#6B6357]"
                data-testid="text-signup-body"
              >
                Šiuo metu tikriname susidomėjimą ir renkame nuomonę, prieš
                nuspręsdami dėl gamybos. Palikite el. paštą – pranešime, kai
                turėsime daugiau naujienų.
              </p>
        ...
        <footer
          className="border-t border-[#D8CDBE] px-6 py-8 sm:px-10 sm:py-10 lg:px-16"
        ...
        >
          <div className="mx-auto flex w-full max-w-5xl flex-col gap-3 text-sm text-[#6B6357] sm:flex-row sm:items-center sm:justify-between">
            <span
              className="font-serif text-lg text-[#2B2620]"
              data-testid="text-footer-wordmark"
            >
              Balso Būdelė
            </span>
            <a
              href="mailto:info@balsobudele.lt"
